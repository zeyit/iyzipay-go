...
type CreatePayWithIyzicoInitializeRequest struct {
	*BaseRequest
...
func NewCreatePayWithIyzicoInitializeRequest() *CreatePayWithIyzicoInitializeRequest {
	return &CreatePayWithIyzicoInitializeRequest{BaseRequest: NewBaseRequest()}
}

func (c *CreatePayWithIyzicoInitializeRequest) ToPKIRequestString() string {
